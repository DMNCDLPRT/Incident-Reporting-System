<div class="bg-white p-8 rounded-md w-full">
    <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
        ...
        <div class="block w-full overflow-x-auto">
            <div>
                <x-jet-form-section submit="addIncident">
                    <x-slot name="form">
                        <x-slot name="title">
                            {{ __('Add Incident') }}
                        </x-slot>
                        ...
                        <div>
                            ...
                            @enderror
                            <x-jet-label for="report_name" value="{{ __('Incident Name') }}" />
                            <x-jet-input id="report_name" wire:model="report_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="report_name" :value="old('report_name')" placeholder="Add incident" autofocus />
                        </div>

                        <x-slot name="actions">
                            <x-jet-button wire:loading.attr="disabled" onclick="return confirm('Confirm add Incident');">
                                {{ __('Add Incident') }}
                            </x-jet-button>   
                          </x-slot>
                    </x-slot>
