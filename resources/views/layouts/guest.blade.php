    ...
    <body class="bg-white dark:bg-gray-700">
        ...
        <footer class="bg-slate-200 md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
            <ul class="flex items-center flex-wrap mb-6 md:mb-0">
               <li><a href="{{ route('terms.show') }}" class="text-sm font-normal text-gray-600 hover:underline mr-4 md:mr-6">Terms and conditions</a></li>
               <li><a href="{{ route('policy.show') }}" class="text-sm font-normal text-gray-600 hover:underline mr-4 md:mr-6">Privacy Policy</a></li>
               <li><a href="{{ route('faq') }}" class="text-sm font-normal text-gray-600 hover:underline mr-4 md:mr-6">FAQ</a></li>
               <li><a href="https://www.facebook.com/LGUDonCarlos" class="text-sm font-normal text-gray-600 hover:underline">Contact</a></li>
            </ul>
            <div class="flex sm:justify-center space-x-6">
               <a href="https://www.facebook.com/LGUDonCarlos" class="text-gray-600 hover:text-gray-900">
                  <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                     <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                  </svg>
               </a>
               <a href="https://github.com/DMNCDLPRT/Quick-Emergency-Portal" class="text-gray-600 hover:text-gray-900">
                  <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
