    ...
    <div class="rounded-b-lg bg-red-600 p-5 pb-20 text-white">
      ...
      <div class="space-y-2 text-center">
          ...
          <div class="text-slate-200">
              <span class="activity-header">Report an incident through this web application. When you reporting an incident the assgined responders/departmen will we be notified.</span>
          </div>
      </div>
    </div>
