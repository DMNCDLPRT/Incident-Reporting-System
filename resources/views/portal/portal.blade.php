          ...
          <div class="h-full bg-gray-50">
              <div class="rounded-b-lg bg-red-600 p-5 pb-20 text-white">
                <div class="mb-4 text-center"> 
                  <h1 class="text-3xl font-semibold">Quck Response Portal</h1>
                </div>
                <div class="space-y-2 text-center">
                    <div class="text-2xl font-bold tracking-wider">Push SOS for Rescue</div>
                    <div class="text-slate-200">
                        <span class="activity-header">Your location is based on the portal you are connected</span>
                    </div>
                </div>
              </div>
