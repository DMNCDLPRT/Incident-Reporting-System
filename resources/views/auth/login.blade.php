<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <a type="button" href="{{ url('auth/google') }}" class="flex items-center justify-center flex-none mt-3 px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black relative w-full">
