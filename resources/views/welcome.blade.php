                    ...
                    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div class="flex items-center lg:order-2">
                            @if (Route::has('login'))
                                @auth
                                @role('User')
                                <a href="{{ url('/portal/portal') }}" class="text-white bg-emerald-500 shadow-2xl hover:bg-emerald-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-emerald-500 dark:hover:bg-emerald-400focus:outline-none dark:focus:ring-blue-800">
                                    Report Incident
                                </a>
                                @endrole

                                @role('Admin|Department')
                                <a href="{{ url('/dashboard') }}" class="text-white bg-emerald-500 shadow-2xl hover:bg-emerald-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-emerald-500 dark:hover:bg-emerald-400focus:outline-none dark:focus:ring-blue-800">
                                    Home 
                                </a>
                                @endrole
                                @else
                                <a href="{{ route('register') }}" class="text-white bg-emerald-500 shadow-2xl hover:bg-emerald-400 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-emerald-500 dark:hover:bg-emerald-400focus:outline-none dark:focus:ring-blue-800">
                                    ...
                                    <a href="{{ route('login') }}" class="text-gray-800 dark:text-white bg-slate-400 shadow-2xl hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
                                        Sign-in 
                                    </a>
                                    @endif
                                @endauth 
